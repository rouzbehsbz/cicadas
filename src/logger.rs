...
use crate::{http::StatusCodeCategory, parser::Arguments, storage::Storage};

pub struct Logger;

impl Logger {
    pub fn show_overview(arguments: &Arguments, storage: Arc<Storage>) {
    ...
    pub fn show_results(storage: Arc<Storage>) {
